...
<header class="main-header">
    ...
    <!-- Logo -->
    <a href="{{ url('/home') }}" class="logo" style="height: 55px;">
        <!-- mini logo for sidebar mini 50x50 pixels -->
        <span class="logo-mini"><img src="{{ asset('/img/logo-symbol.png') }}" alt="SGASL" style="width: 50px; height: 50px;"></span>
        <!-- logo for regular state and mobile devices -->
        <span class="logo-lg"><img src="{{ asset('/img/logo-symbol.png') }}" alt="SGASL" style="width: 50px; height: 50px;"> SGAS Leire</span>
    </a>
